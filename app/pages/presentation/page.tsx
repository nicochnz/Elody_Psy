  ...
  return (
    <div>
      ...
      <section className="bg-primary py-12 md:px-44">
        <h1 className="text-3xl font-black text-secondary py-8 text-center uppercase md:text-left">À propos de moi</h1>
        <Image src="/third_home.png" alt="À propos de moi" width={290} height={290} className="rounded-full justify-center mx-auto mb-8 aspect-square object-cover md:w-[1200px] md:h-[500px] md:rounded-lg" />
        <p className="py-2 px-12 md:px-0"><span className="font-bold">Je m’appelle Elody Adjei Owusu, psychopraticienne spécialisée </span> en psychothérapie intégrative, neurosciences et régulation émotionnelle. </p>
        <p className="py-2 px-12 md:px-0">Mon parcours dans le domaine médical, notamment en radiologie, m’a permis de développer une compréhension rigoureuse du corps et du système nerveux. Mais au-delà de la structure biologique, j’ai très vite perçu que la véritable santé repose sur un équilibre plus vaste : celui du psychique, de l’émotionnel et du corporel.</p>
        <p className="py-2 px-12 md:px-0">Après plusieurs années d’engagement dans le soin, j’ai traversé un burn-out et j’ai été diagnostiqué d’un<span className="font-bold"> TDAH</span>, une expérience fondatrice qui m’a confrontée à mes propres limites.Cette épreuve a nourri une conviction profonde :<span className="font-bold"> on ne soigne pas durablement ce que l’on ne comprend pas. </span></p>
        <p className="py-2 px-12 mb-4 md:px-0">C’est ce qui m’a conduite à me former en thérapies <span className="font-bold"> cognitivo-comportementales (TCC) </span>, en psychologie appliquée et en régulation du système nerveux, pour proposer aujourd’hui un accompagnement fondé sur la science, l’écoute et la transformation concrète.</p>
      ...
      <section className="bg-white-custom py-12 px-7 md:py-24 md:px-20">
        <div className="bg-primary rounded-2xl overflow-hidden flex flex-col md:flex-row max-w-7xl mx-auto min-h-[548px]">
          ...
          <div className="flex-1 px-6 py-8 md:p-16 flex flex-col justify-center">
            <h1 className="text-3xl md:text-4xl font-black text-secondary mb-6">Mon approche</h1>
            <div className="space-y-4 text-base md:text-lg leading-relaxed">
              ...
              <p>
                ...
                <span className="font-bold"> thérapies cognitivo-comportementales (TCC), à la régulation émotionnelle et aux neurosciences.</span> Aujourd’hui, mon approche se veut psychothérapeutique et intégrative, alliant rigueur scientifique et écoute profonde du vécu émotionnel.
              </p>
              <p>
                <span className="font-bold">Un accompagnement psychothérapeutique et psycho-émotionnel permet de libérer les blocages intérieurs en reliant le corps, le mental et les émotions.</span> Il s’appuie sur les neurosciences, la psychologie et la régulation émotionnelle pour comprendre les mécanismes profonds qui influencent ton état intérieur, tes comportements et ta façon de réagir au monde.
              </p>
            </div>
          </div>
        </div>
      ...
      <section className="mt-10 px-10 md:px-44">
        ...
        <ul className="list-disc py-3">
          ...
          <li className="ml-8 py-3">Vis des difficultés de concentration, d’attention ou de motivation liées au TDAH ou à une hypersensibilité ; 
          </li>
          <li className="ml-8 py-3">Te sens souvent envahie par tes émotions (angoisse, irritabilité, peur, hyperactivité mentale, impulsivité) ; 
          </li>
          <li className="ml-8 py-3">Répètes des schémas d’auto-sabotage, de surcontrôle ou de perfectionnisme ;
          </li>
          <li className="ml-8 py-3">Souhaites retrouver un équilibre intérieur durable, une clarté mentale et une stabilité émotionnelle. 
          </li>
            </ul>
